# Part 4: Deploy as a Module (~10 min)
...
> **The key pattern:** The generator created module infrastructure. You added business logic (`Detect`, `Inspect`) and a client interface (`DoCommand`). The same `NewInspector` constructor works for both CLI testing and module deployment.
